...
#let headerQuoteInternational = (
  "": [Software developer looking for a part-time job],
  "en": [Software developer looking for a part-time job],
  "fr": [Développeur logiciel cherchant un emploi en alternance],
)
