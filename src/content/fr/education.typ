...
#cvEntry(
  title: [Bachelor - Informatique], organisation: [HEPIA], logo: "", date: [2024 - Présent], location: [Genève], description: list(
...
#cvEntry(
  title: [Technicien ES - Développement d'applications], organisation: [CFPT], logo: "", date: [2022 – 2024], location: [Genève], description: list(
