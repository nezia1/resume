...
#let skillTypeStyle(str) = { text(size: 12pt, weight: "bold", str) }

#let languageNameStyle(str) = { text(size: 12pt, weight: "bold", str) }

#let languageInfoStyle(str) = { text(str) }

#let descriptionStyle(str) = { text(fill: textColors.darkGray, str) }

#let tagStyle(str) = { align(center, text(size: 11pt, weight: "regular", str)) }
...
#let cvInterestTags(tags: ()) = {
  tagListStyle(tags)
}

#let cvInterestDescription(description: "Description") = {
  descriptionStyle(description)
}
...
/* Layout */
#let layout(doc) = {
  set text(font: textFont, weight: "regular", size: 11pt)
